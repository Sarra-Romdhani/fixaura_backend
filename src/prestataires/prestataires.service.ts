...
//   async flagPrestataire(id: string, reason: string): Promise<void> {
...
//     await this.prestataireModel.findByIdAndUpdate(id, updateData).exec();
//     console.log(`Prestataire ${id} flagged. Flag count: ${newFlagCount}, Reason: ${reason}`);
//   }
...
//     const jobs = await this.prestataireModel
//       .distinct('job', { category: { $regex: new RegExp(category, 'i') } })
//       .exec();
